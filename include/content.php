...
class DBKeywords extends DBItem{
    ...
    public function readContents($product)
    {
...
class DBProducts extends DBItem{
    ...
    public function readContents($user)
    {
        $tmp = ['prUser' => $user];
        return parent::readContents(self::$readstr, $tmp); // TODO: Change the autogenerated stub
    }
...
class DBComments extends DBItem{
    ...
    public function readContents($linkid)
    {
        $tmp = ['komLink' => $linkid];
        return parent::readContents(self::$readstr, $tmp); // TODO: Change the autogenerated stub
    }

    public function insertContents($text, $linkid){
...
class DBResult extends DBItem{
    ...
    public function insertContents($komId, $kzId, $datum)
    {
