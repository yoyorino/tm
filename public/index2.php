...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="/track_mention/public/dashboard.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
            </li>
            <li>
...
<div class="container-fluid" style="background-color: black">
    <div class="row">
        <div class="col-md-offset-1 col-md-7">
            <h1 style="color: white; font-size: 2em;">In tempor aliquam purus eu sagittis</h1>
            <h2 style="color: #1b6d85; font-size: 1em;">Sed ultrices tristique magna non accumsan massa vel libero posuere sagitt nisi</h2>
        ...
        <div class="col-md-3 col-md-offset-right-1">
            <h1 style="color: white; font-size: 2em">Nullam eleme</h1>
            <h2 style="color: #1b6d85; font-size: 1em;">Nam fermentum ornare dui</h2>
            <p>Proin egestas, dolor ut imperdiet porta, velit lorem luctus massa, a pharetra felis lorem a nulla ivam.</p>
            <h3 style="font-size: 1em; color: white;">Email: info@untitled.com</h3>
            <h3 style="font-size: 1em; color: white;">Phone: (800) 555-0000</h3>
        </div>
    </div>
</div>
<!-- END OF ABOUT US -->
<!-- COPYRIGHT -->
<div class="container-fluid" style="background: url(images/panel-bg.png);">
    <div class="row">
        <div class="col-md-12">
            <p style="color: #8b8b8b; text-align: center; line-height: 40px; margin: 0;">Copyright (c) Untitled. Design by wwww.alltemplateneeds.com . Photos by photorack.net</p>
        </div>
    </div>
</div>
<!-- END OF COPYRIGHT -->
